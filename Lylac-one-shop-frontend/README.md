# [Rajaram Pharmacy](https://Rajaram-frontend.vercel.app/) &middot; [![Author Sanskar Gupta](https://img.shields.io/badge/Author-Sanskar-%3C%3E)](https://www.linkedin.com/in/sanskar-gupta-12476423b/)  
[![GitHub](https://img.shields.io/badge/GitHub-%3C%3E)](https://github.com/Sanskargupta0/Rajaram-Frontend)  
...
1. **[Rajaram Backend](https://github.com/Sanskargupta0/Rajaram-Backend)**: Main API server handling:
...
2. **[Rajaram Admin Panel](https://github.com/Sanskargupta0/Rajaram-Admin)**: Administrative interface for:
...
```bash
git clone https://github.com/Sanskargupta0/Rajaram-Frontend.git
cd Rajaram-Frontend
```
...
1. **Set up the [Rajaram Backend](https://github.com/Sanskargupta0/Rajaram-Backend)**:
...
2. **Set up the [Rajaram Admin Panel](https://github.com/Sanskargupta0/Rajaram-Admin)** (optional for basic functionality):
...
### Backend Integration
- `VITE_BACKEND_URL`: URL of your Rajaram backend server (e.g., `http://localhost:4000` for local development)
...
1. Use the [Rajaram Admin Panel](https://github.com/Sanskargupta0/Rajaram-Admin) to:
...
2. Review the [backend repository](https://github.com/Sanskargupta0/Rajaram-Backend) for API-related issues
3. Check the [admin panel repository](https://github.com/Sanskargupta0/Rajaram-Admin) for management-related questions
...
- **[Rajaram Backend](https://github.com/Sanskargupta0/Rajaram-Backend)**: Main API server and business logic
- **[Rajaram Admin Panel](https://github.com/Sanskargupta0/Rajaram-Admin)**: Administrative interface for managing the platform
