...
const Policy = () => {
  const [contactInfo, setContactInfo] = useState({
    footerEmail: "Rajarampharmacy@gmail.com",
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-xl font-semibold">
                Rajaram Pharmacy Terms and Conditions
              </h2>
            </div>
            <button
          ...
          <div className="text-gray-600 space-y-6" id="terms-content">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p>
                  By accessing or using Rajaram Pharmacy Medicine services, you
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p>
                  Rajaram Pharmacy strives to deliver medicines within the
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p>
                  Rajaram Pharmacy provides information on medicines for general
        ...
        <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
          <p className="text-sm text-gray-500 text-center">
            Last updated: March 2025. Rajaram Pharmacy reserves the right to modify
