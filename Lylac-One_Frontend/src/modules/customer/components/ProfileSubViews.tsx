...
import { MedicineCard } from "../../store/components/Cards";
...
export function ProfileSubView({
  ...
  switch (view) {
    case "edit-profile":
      return <EditProfileView onBack={onBack} />;
    case "addresses":
      return <AddressesView onBack={onBack} />;
    case "wishlist":
      return (
        <WishlistView
          onBack={onBack}
          ...
          onOpenMedicine={(id) => onNavigate("medicine", id)}
        />
      );
    case "prescription-history":
      return <PrescriptionHistoryView onBack={onBack} />;
    case "uploaded-prescriptions":
      return <UploadedPrescriptionsView onBack={onBack} />;
    case "saved-pharmacies":
      return (
        <SavedPharmaciesView
          onBack={onBack}
          onOpenStore={(id) => onNavigate("store", id)}
        />
      );
    case "notifications":
      return <NotificationsView onBack={onBack} />;
    case "payment-methods":
      return <PaymentMethodsView onBack={onBack} />;
    case "wallet":
      return <WalletView onBack={onBack} />;
    case "loyalty":
      return <LoyaltyView onBack={onBack} />;
    case "family":
      return <FamilyView onBack={onBack} />;
    case "health-records":
      return <HealthRecordsView onBack={onBack} />;
    case "reminders":
      return <RemindersView onBack={onBack} />;
    case "coupons":
      return <CouponsView onBack={onBack} />;
    case "referral":
      return <ReferralView onBack={onBack} />;
    case "help":
      return <HelpView onBack={onBack} onNavigate={onNavigate} />;
    case "contact":
      return <ContactView onBack={onBack} />;
    case "privacy-policy":
      return <PolicyView onBack={onBack} title="Privacy Policy" />;
    case "terms":
      return <PolicyView onBack={onBack} title="Terms & Conditions" />;
    case "about":
      ...
      <div className="container py-4 max-w-2xl">
        <div className="flex flex-col items-center py-4">
          <div className="relative">
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-white text-3xl font-bold shadow-glow">
              A
            </div>
            <button className="absolute -bottom-1 -right-1 w-8 h-8 rounded-full bg-white shadow-lg flex items-center justify-center border border-border">
  ...
  return (
    <div className="pb-24 md:pb-8">
      ...
      <div className="container py-4 max-w-2xl space-y-3">
        ...
        <Button
          variant="outline"
          className="w-full rounded-full h-12 border-dashed border-2 gap-2"
        >
        ...
        {items.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Tap the heart on medicines to save them
            </p>
          </div>
        ) : (
            ...
            {items.map((m) => (
              <div key={m.id} className="relative">
                ...
                <button
                  ...
                  className="absolute top-2 right-2 w-8 h-8 rounded-full bg-white shadow-lg flex items-center justify-center hover:bg-destructive hover:text-white transition"
                >
    ...
    <div className="pb-24 md:pb-8">
      ...
      <div className="container py-4 max-w-3xl space-y-3">
        {PHARMACIES.slice(0, 3).map((p) => (
          <Card
            key={p.id}
            className="p-3 flex items-center gap-3 hover:shadow-card cursor-pointer"
            onClick={() => onOpenStore(p.id)}
          >
  ...
  const notifs = [
    {
      ...
      s: "Your order ORD-2451 will arrive in 20 min",
      time: "5m ago",
      new: true,
      icon: "🚚",
    ...
    {
      t: "Refill Reminder",
      s: "Time to refill your Glycomet 500mg",
      time: "2h ago",
      new: true,
      icon: "💊",
    ...
    {
      t: "FLAT 25% OFF",
      s: "On all Vitamins today only",
      time: "5h ago",
      icon: "🎁",
      bg: "bg-purple-50 dark:bg-purple-950",
    },
    {
      t: "Prescription verified",
      s: "Dr. Meera Iyer's prescription approved",
      time: "1d ago",
      icon: "✅",
      bg: "bg-emerald-50 dark:bg-emerald-950",
    },
    {
      t: "You earned 50 Lylac Points",
      s: "For your recent order ORD-2440",
      time: "3d ago",
      icon: "⭐",
    ...
    <div className="pb-24 md:pb-8">
      ...
      <div className="container py-4 max-w-2xl space-y-2">
        {notifs.map((n, i) => (
          <Card
            key={i}
            className={`p-4 flex items-start gap-3 ${n.new ? "border-l-4 border-l-primary" : ""}`}
          >
            <div
              className={`w-10 h-10 rounded-full ${n.bg} flex items-center justify-center text-lg`}
            >
              {n.icon}
            </div>
            <div className="flex-1">
      ...
      <div className="container py-4 max-w-2xl space-y-3">
        <div>
          ...
          <Card className="divide-y">
            {[
              { n: "arjun@okhdfcbank", b: "HDFC Bank" },
              { n: "arjun.sharma@paytm", b: "Paytm" },
            ].map((u) => (
              <div key={u.n} className="flex items-center gap-3 p-4">
                ...
                <div className="flex-1">
                  <div className="font-medium text-sm">{u.n}</div>
                  <div className="text-xs text-muted-foreground">{u.b}</div>
                </div>
        ...
        <div>
          <h3 className="text-xs font-bold text-muted-foreground uppercase mb-2 mt-4">
            Cards
          </h3>
          <Card className="divide-y">
            {[
              { n: "**** 4242", b: "HDFC Visa Credit" },
              { n: "**** 5589", b: "ICICI Mastercard Debit" },
            ].map((c) => (
              <div key={c.n} className="flex items-center gap-3 p-4">
                <div className="w-10 h-10 rounded-lg bg-indigo-100 dark:bg-indigo-950 text-indigo-600 flex items-center justify-center">
                  <CreditCard className="w-4 h-4" />
                </div>
                <div className="flex-1">
                  <div className="font-medium text-sm">{c.n}</div>
                  <div className="text-xs text-muted-foreground">{c.b}</div>
                </div>
                <Trash2 className="w-4 h-4 text-destructive cursor-pointer" />
              </div>
            ))}
      ...
      <div className="container py-4 max-w-2xl">
        <Card className="p-6 gradient-hero text-white">
          ...
          <div className="text-sm opacity-90 mt-1">
            Instant refunds • No expiry
          </div>
          <div className="mt-4 flex gap-2">
            <Button
              variant="secondary"
              className="rounded-full bg-white text-primary hover:bg-white/95"
            >
              Add Money
            </Button>
            <Button
          ...
          <Card className="divide-y">
            {txns.map((t, i) => (
              <div key={i} className="flex items-center justify-between p-4">
                <div>
                  <div className="font-medium text-sm">{t.t}</div>
                  <div className="text-xs text-muted-foreground">{t.d}</div>
                </div>
                <div className={`font-bold ${t.a > 0 ? "text-success" : ""}`}>
                  {t.a > 0 ? "+" : ""}₹{Math.abs(t.a)}
                </div>
              </div>
            ))}
        ...
        <div className="mt-6">
          ...
          <Card className="divide-y">
            {[
              ...
              <div key={r.l} className="flex items-center justify-between p-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mt-4">
          {cats.map((c) => (
            <Card key={c.t} className="p-4 hover:shadow-card cursor-pointer">
              <div
                className={`w-11 h-11 rounded-xl ${c.color} flex items-center justify-center text-xl`}
              >
                {c.i}
              </div>
  ...
  const reminders = [
    {
      n: "Glycomet 500mg",
      t: "8:00 AM, 8:00 PM",
      d: "After meals • 30 days left",
      a: true,
    },
    {
      n: "Vitamin C 500mg",
      t: "9:00 AM",
      d: "Before breakfast • Ongoing",
      a: true,
    },
    {
      n: "Ecosprin 75mg",
      t: "10:00 PM",
      d: "Bedtime • 15 days left",
      a: false,
    },
  ];
  return (
          ...
          <Card key={i} className="p-4 flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-muted-foreground flex items-center gap-1 mt-0.5">
                <Clock className="w-3 h-3" /> {r.t}
              </div>
              <div className="text-xs text-muted-foreground">{r.d}</div>
            </div>
            <Badge
              className={
                r.a ? "bg-success text-white" : "bg-muted text-muted-foreground"
              }
            >
              {r.a ? "Active" : "Paused"}
            </Badge>
...
function CouponsView({ onBack }) {
  const coupons = [
    {
      c: "HEALTH25",
      d: "25% off on Vitamins",
      exp: "Expires 30 Jun",
      color: "from-purple-500 to-pink-500",
    },
    {
      c: "FIRST100",
      d: "₹100 off first order",
      exp: "Expires 15 Jul",
      color: "from-teal-500 to-emerald-500",
    },
    {
      c: "FREEDEL",
      d: "Free delivery on ₹299+",
      exp: "Expires 20 Jul",
      color: "from-amber-500 to-orange-500",
    },
    {
      c: "B2G1",
      d: "Buy 2 Get 1 Personal Care",
      exp: "Expires 10 Jul",
      ...
      <div className="container py-4 max-w-2xl space-y-3">
        {coupons.map((c) => (
          <Card key={c.c} className="overflow-hidden">
            <div className="flex">
              <div
                className="p-4 flex flex-col items-center justify-center text-white text-center"
                style={{
                  background: `linear-gradient(135deg,${c.color.includes("purple") ? "#a855f7,#ec4899" : c.color.includes("teal") ? "#14b8a6,#10b981" : c.color.includes("amber") ? "#f59e0b,#f97316" : "#f43f5e,#ef4444"})`,
                  minWidth: 110,
                }}
              >
              ...
              <div className="flex-1 p-4">
                ...
                <div className="mt-2 flex items-center justify-between">
                  ...
                  <button
                    onClick={() => {
                      navigator.clipboard?.writeText(c.c);
                      toast.success("Copied!");
                    }}
                    className="text-primary font-semibold text-xs flex items-center gap-1"
                  >
      ...
      <div className="container py-4 max-w-2xl">
        <Card className="p-6 text-center">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Refer friends to Lylac One. You both get ₹100 wallet credit when
          ...
          <div className="mt-6 p-4 rounded-2xl border-2 border-dashed border-primary bg-accent/30">
            ...
            <div className="text-3xl font-extrabold text-primary mt-1 tracking-wider">
              ARJUN25
            </div>
          </div>
          <div className="mt-4 grid grid-cols-2 gap-2">
            ...
            <Button
              ...
              onClick={() => {
                navigator.clipboard?.writeText("ARJUN25");
                toast.success("Copied!");
              }}
            >
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div>
              <div className="text-2xl font-bold text-success">₹800</div>
  ...
  const faqs = [
    {
      ...
      a: "Go to cart → checkout → upload prescription. Our pharmacist verifies within 15 minutes.",
    },
    {
      q: "What is the delivery time?",
      a: "15 minutes to 2 hours depending on your chosen pharmacy and slot.",
    },
    {
      q: "Are all medicines genuine?",
      a: "Yes, we partner only with licensed pharmacies. Every product is sealed and verified.",
    },
    {
      q: "How can I cancel an order?",
      a: "Cancel from Orders page within 5 minutes of placing. Beyond that, contact support.",
    },
  ];
  return (
    <div className="pb-24 md:pb-8">
      ...
      <div className="container py-4 max-w-2xl">
        <Card className="p-4 gradient-card">
          <Input
            ...
            className="h-11 border-0 bg-white dark:bg-background"
          />
        </Card>
        <div className="mt-4">
          ...
          <Card className="divide-y">
            {faqs.map((f, i) => (
              <details key={i} className="group">
                <summary className="p-4 cursor-pointer flex items-center justify-between font-medium text-sm">
                  {f.q}
        ...
        <Button
          onClick={() => onNavigate("profile-sub", "contact")}
          variant="outline"
        ...
        {[
          {
            icon: Phone,
            l: "Call us",
            s: "+91 1800 123 4567 • 24×7",
            color: "bg-emerald-100 dark:bg-emerald-950 text-emerald-600",
          },
          {
            icon: MessageCircle,
            l: "Chat with us",
            s: "Live chat • Avg reply 2 min",
            color: "bg-blue-100 dark:bg-blue-950 text-blue-600",
          },
          {
            icon: Mail,
          ...
          return (
            <Card
              key={c.l}
              className="p-4 flex items-center gap-3 cursor-pointer hover:shadow-card"
            >
              <div
        ...
        <Card className="p-5 mt-4">
          ...
          <div className="space-y-2">
            ...
            <Button
              ...
              onClick={() =>
                toast.success("Message sent! We'll reply in 2 hours.")
              }
            >
              Send Message
            </Button>
      ...
      <div className="container py-4 max-w-3xl prose prose-sm dark:prose-invert">
        <div className="space-y-4 text-sm leading-relaxed">
          ...
          {[
            {
              h: "1. Introduction",
              p: `This ${title} governs your use of Lylac One's services. By accessing our app, you agree to these terms.`,
            },
            {
              h: "2. Data Collection",
              p: "We collect personal information (name, phone, address) and health data (prescriptions, orders) solely to provide our services. Data is encrypted at rest and in transit.",
            },
            {
              h: "3. Third-Party Sharing",
              p: "We share order data with partner pharmacies for fulfilment and with delivery partners for logistics. We never sell your personal information.",
            },
            {
              h: "4. Prescription Handling",
              p: "Prescriptions are stored in your Digital Health Vault. Only you and verified pharmacists can access them.",
            },
            {
              h: "5. Your Rights",
              p: "You may request data export, correction, or deletion at any time by contacting help@lylacone.com.",
            },
            {
              h: "6. Cookies & Analytics",
              p: "We use minimal cookies for session management and analytics to improve the app experience.",
            },
            {
              h: "7. Contact",
              p: "For any questions, reach us at legal@lylacone.com.",
            },
          ].map((s) => (
            <div key={s.h}>
    ...
    <div className="pb-24 md:pb-8">
      ...
      <div className="container py-4 max-w-2xl">
        <Card className="p-6 text-center">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            v1.0.0 • Made with ❤️ in Bengaluru
          </p>
          <p className="text-sm mt-4">
            Lylac One is a hyperlocal online pharmacy marketplace that connects
            you with verified neighbourhood pharmacies for genuine medicines,
        ...
        <div className="mt-4 space-y-2">
          {[
            ...
            <Card
              key={l}
              className="p-4 flex items-center justify-between hover:shadow-card cursor-pointer"
            >
  ...
  return (
    <div className="pb-24 md:pb-8">
      ...
      <div className="container py-4">
        {items.length === 0 ? (
          <div className="text-center py-16">
            <div className="w-20 h-20 rounded-full bg-accent mx-auto flex items-center justify-center mb-3 text-3xl">
              ⚖️
            </div>
            <h3 className="font-bold text-lg">Nothing to compare yet</h3>
            <p className="text-sm text-muted-foreground mt-1">
              Add medicines to compare their price, dosage, and reviews
              side-by-side.
            </p>
          </div>
        ) : (
          <div className="overflow-x-auto no-scrollbar">
            <div className="min-w-full inline-block">
              <table className="w-full border-separate border-spacing-0">
                <thead>
                  <tr>
                    <th className="text-left p-3 text-xs font-bold text-muted-foreground uppercase sticky left-0 bg-background z-10 border-b border-border">
                      Attribute
                    </th>
                    {items.map((m) => (
                      <th
                        key={m.id}
                        className="p-3 min-w-[220px] border-b border-border"
                      >
                        <div className="relative rounded-xl bg-muted p-3">
                          <button
                            onClick={() => removeCompare(m.id)}
                            className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-destructive text-white flex items-center justify-center text-xs"
                          >
                            ×
                          </button>
                          <div className="aspect-square w-24 mx-auto rounded-lg overflow-hidden mb-2">
                            <img
                              src={m.image}
                              alt=""
                              className="w-full h-full object-cover"
                ...
                <tbody>
                  {(
                    [
                      ...
                      [
                        "Pack",
                        (m) => <span className="text-sm">{m.pack}</span>,
                      ],
                      [
                        "Composition",
                        (m) => <span className="text-sm">{m.composition}</span>,
                      ],
                      [
                        "Uses",
                        (m) => (
                      ...
                      [
                        ...
                        (m) =>
                          m.rx ? (
                            ...
                            <span className="text-success">Not required</span>
                          ),
                      ],
                      [
                        "Manufacturer",
                        (m) => (
                          <span className="text-sm">{m.manufacturer}</span>
                        ),
                      ],
                    ] as [string, (medicine: any) => React.ReactNode][]
                  ).map(([label, render]) => (
                    <tr key={label} className="border-b border-border">
                      <td className="p-3 text-sm font-semibold sticky left-0 bg-background z-10">
                        {label}
                      </td>
                      {items.map((m) => (
