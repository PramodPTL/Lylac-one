...
function FormRow({ label, type = 'text', defaultValue = '' }: { label: string; type?: string; defaultValue?: string }) {
  return (
    <div>
...
function ToggleRow({ icon: Icon, label, sub, defaultChecked }: { icon?: React.ElementType; label: string; sub: string; defaultChecked?: boolean }) {
