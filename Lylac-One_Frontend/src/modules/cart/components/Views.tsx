              ...
              <SheetContent side="right" className="w-full sm:max-w-md overflow-y-auto">
                ...
                <div className="mt-6 space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <label className="flex items-center gap-2 text-sm"><Checkbox checked={filters.inStock} onCheckedChange={(c) => setFilters({ ...filters, inStock: c === true })} /> In Stock only</label>
                    <label className="flex items-center gap-2 text-sm"><Checkbox checked={filters.rx} onCheckedChange={(c) => setFilters({ ...filters, rx: c === true })} /> Prescription Required</label>
                  </div>
                  <div>
