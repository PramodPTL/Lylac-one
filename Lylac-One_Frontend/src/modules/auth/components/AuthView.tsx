        ...
        >
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              ...
              {step === "signup" &&
                "Get 15-min delivery from nearby pharmacies"}
              {step === "otp" &&
                `We've sent a 4-digit code to ${form.phone || "+91 98765 43210"}`}
              {step === "forgot" &&
          ...
          <Card className="p-6 shadow-card">
            {step === "login" && (
              <form onSubmit={submitLogin} className="space-y-4">
                ...
                <Button
                  ...
                  size="lg"
                  disabled={busy}
                  className="w-full rounded-full bg-secondary hover:bg-secondary/90 font-semibold"
                >
            ...
            <Button
              ...
              size="lg"
              onClick={() => {
                toast.info("Google login (placeholder)");
                onSuccess?.();
              }}
          ...
          <div className="mt-6 flex items-center justify-center gap-4 text-[11px] text-muted-foreground">
            <span className="flex items-center gap-1">
              <ShieldCheck className="w-3 h-3" /> Verified pharmacies
            </span>
            <span className="flex items-center gap-1">
              <Sparkles className="w-3 h-3" /> 15-min delivery
            </span>
          </div>
        </motion.div>
      </div>
